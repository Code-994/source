#!/bin/bash
# ==============================================================================
# ISCX-Tor-2016 双阶段（phase1 → phase2_direct）评估 —— v3 版
# 对应训练：scripts/train/iscxtor/train_mambanetburst_tor2016-phase2_direct.sh
#
# v3：eval_cls_head_qwen_sample_LLMclass_mGPU_v3.py，带 cls_head 兜底 + train_data。
# 非合并模型（base+fresh LoRA），加载简单，无 docs §9.3 合并权重坑。
# ==============================================================================
...
echo ">>> [Tor phase2 Eval v3] (with cls_head fallback)"

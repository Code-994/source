#!/bin/bash
# 实验2推理评估: MambaNetBurst + mmTraffic on ISCX-Tor-2016 BGTD
# 对应训练: train_mambanetburst_tor2016_full.sh
...
VT_CKPT="/root/autodl-tmp/mmTraffic/output/ISCX-Tor-2016/mambanetburst_lora/vision_tower/pytorch_model.bin"  # 微调后权重
...
OUTPUT_DIR="/root/autodl-tmp/mmTraffic/output/ISCX-Tor-2016/mambanetburst_lora/eval_results"

mkdir -p "$OUTPUT_DIR"

echo ">>> [Eval2] MambaNetBurst + mmTraffic on ISCX-Tor-2016"

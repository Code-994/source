#!/bin/bash
# ==============================================================================
# ISCX-Tor-2016 单阶段（mambanetburst_lora）评估 —— v4 前缀强制重生成兜底
...
RUN_DIR="/root/autodl-tmp/mmTraffic/output/ISCX-Tor-2016/mambanetburst_lora"
...
echo ">>> [Tor 单阶段 Eval v4] cls_head 兜底 + 前缀强制重生成报告"

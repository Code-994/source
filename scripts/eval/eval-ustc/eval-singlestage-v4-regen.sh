#!/bin/bash
# ==============================================================================
# USTC-TFC-2016 单阶段（mambanetburst_lora_12cls）评估 —— v4 前缀强制重生成兜底
...
RUN_DIR="/root/autodl-tmp/mmTraffic/output/USTC-TFC-2016/mambanetburst_lora_12cls"

CHECKPOINT_PATH="$RUN_DIR"
VT_CKPT="$RUN_DIR/vision_tower/pytorch_model.bin"
CLS_HEAD_PATH="$RUN_DIR/cls_head"
TRAIN_DATA="/root/autodl-tmp/mmTraffic/data/USTC-TFC-2016/nlp_output_LLMclass_3000_6000/train.jsonl"
...
echo ">>> [USTC 单阶段 Eval v4] cls_head 兜底 + 前缀强制重生成报告"

#!/bin/bash
# 实验3-v1推理评估: MambaNetBurst(12cls预训练) + mmTraffic on USTC-TFC-2016
# 使用原始推理脚本（无 JSON 格式约束）
...
OUTPUT_DIR="/root/autodl-tmp/mmTraffic/output/USTC-TFC-2016/mambanetburst_lora_12cls/eval_results_v1"

mkdir -p "$OUTPUT_DIR"

echo ">>> [Eval3-12cls-v1] MambaNetBurst(12cls) + mmTraffic on USTC-TFC-2016 (no format constraint)"

#!/bin/bash
# 实验3-v2推理评估 100样本/类: MambaNetBurst(12cls) + mmTraffic on USTC-TFC-2016
...
OUTPUT_DIR="/root/autodl-tmp/mmTraffic/output/USTC-TFC-2016/mambanetburst_lora_12cls/eval_results_v2_100"

mkdir -p "$OUTPUT_DIR"

echo ">>> [Eval3-12cls-v2-100] MambaNetBurst(12cls) + mmTraffic on USTC-TFC-2016 (100 samples/class)"

#!/bin/bash
# 评估 Android Phase1 cls_head 分类精度

export PYTHONPATH="/root/autodl-tmp/mmTraffic:/root/autodl-tmp/MambaNetBurst/src:${PYTHONPATH}"
export TORCH_DTYPE=bfloat16

CHECKPOINT_PATH="/root/autodl-tmp/mmTraffic/output/Crossplatform-Android/mambanetburst_lora_phase1"
VT_CKPT="/root/autodl-tmp/mmTraffic/output/Crossplatform-Android/mambanetburst_lora_phase1/vision_tower/pytorch_model.bin"
CLS_HEAD_PATH="/root/autodl-tmp/mmTraffic/output/Crossplatform-Android/mambanetburst_lora_phase1/cls_head"
...
OUTPUT_DIR="/root/autodl-tmp/mmTraffic/output/Crossplatform-Android/mambanetburst_lora_phase1/eval_results"

mkdir -p "$OUTPUT_DIR"

echo ">>> [Phase1 Eval] cls_head-only 分类 on CrossPlatform-Android (212 类)"

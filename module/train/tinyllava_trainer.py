...
from transformers.trainer import (
    ...
    get_parameter_names,
    has_length,
    # ALL_LAYERNORM_LAYERS,  # transformers 5.x 中已移除
    # ShardedDDPOption,
    logger,
)
try:
    ...
    # transformers 5.x 兼容：该常量仅用于排除 LayerNorm 类参数的 weight decay
...
class LLaVATrainer(Trainer):
    ...
    def _get_train_sampler(self, dataset=None) -> Optional[torch.utils.data.Sampler]:
        # transformers 5.x 新增 dataset 参数，旧版无此参数；兼容两者
